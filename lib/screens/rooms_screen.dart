...
class _RoomsScreenState extends State<RoomsScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadRooms() async {
    ...
    // Carrega as salas que o usuário está participando
    ...
    return Scaffold(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            // Recarrega as salas após retornar dos detalhes
                            _loadRooms();
                          });
                        },
                      ),
      ...
      floatingActionButton: _tabController.index == 0
          ? FloatingActionButton(
              onPressed: () {
                // Navega para a tela de criação de sala
                Navigator.push(
                  context,
                  ...
                  // Recarrega as salas após criar uma nova
                  _loadRooms();
                });
              },
